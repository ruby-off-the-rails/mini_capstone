...
# Product.create(name: "cherry picker", price: 100000, description: "it picks cherries")
# product = Product.new(
#                       name: "WNYX Mug",
#                       price: 2,
...
# Supplier.create(name: "amazon", email: "am@zon.com", phone_number:"12345555")
# Supplier.create(name: "walmart", email: "waltons.com", phone_number:"888888")

# products = Product.all

# products.each do |product|
#   random_id = Supplier.all.sample.id
#   product.supplier_id = random_id
#   product.save
# end
